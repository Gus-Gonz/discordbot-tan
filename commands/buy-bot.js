...
const ppEmail = require("../config.json").ppEmail;

//LIST OF ACCOUNTS

const activeAccountsList = require("../articleData").activeAccountsList;

//LIST OF SERVICES

const activeServicesList = require("../articleData").activeServicesList;
  ...
  async run(discord, bot, message, args) {
    ...
    paymentMethodCollector.on("collect", (message) => {
      ...
      if (paymentMethodContent === "bitcoin" || paymentMethodContent === "2") {
        ticket.send(
          "*If you want to purchase using Bitcoin, then please buy using our website* **https://sellix.io/BestBelieveAcc**\n\n**NOTE:** The ticket is going to get closed in 30s. **(create a new ticket if you want to purchase using PayPal)**"
        );
        ...
        message.channel.send(
          `*You have selected **PayPal** as your payment method.\n\nPlease **note** that **PayPal** prices are* higher than **Bitcoin** prices on our shop.\n\nAlso please **note** that **Tan only** accepts **PayPal** if you have a *Friends & Family* payment option. Some countries that **DOESN'T** have a *Friends & Family* payment option are: *Brazil, China, India, Japan, Jamaica, Aruba*. If your country is in this list, then you **cannot** buy! **(please double check if you're able to send payments as Friends & Family before continuing)**\n\nLastly, **please** make sure that you **accept** these **Terms of service** before you send any money: **https://sellix.io/BestBelieveAcc/category/60792a74204a5**\n\n**NOTE:** Type \`-close\` to close the ticket at any time.`
        );
        ...
        message.channel.send(
          new discord.MessageEmbed()
            ...
            .setDescription(
              "*Have you read and agreed to [these](https://sellix.io/BestBelieveAcc/category/60792a74204a5) terms of services?*\n\n**[1]** *Yes*\n\n**[2]** *No*\n\n**NOTE:** Type `-close` to close the ticket at any time."
            )
            .setColor(0x36393e)
        );
          ...
          if (acceptedTermsContent === "no" || acceptedTermsContent === "2") {
            ...
            message.channel.send(
              new discord.MessageEmbed()
                ...
                .setDescription(
                  "*Please make sure to check the store to get a full list of all our products here:* **https://sellix.io/BestBelieveAcc**\n\n**[1]** *Accounts*\n\n**[2]** *Services*\n\n**NOTE:** Type `-close` to close the ticket at any time."
                )
                .setColor(0x36393e)
            );
            ...
            whatLookingForCollector.on("collect", (message) => {
              ...
              if (collectorContent === "service" || collectorContent === "2") {
                ...
                let description = `*Please make sure to check the store to get a full list of all our products here:* **https://sellix.io/BestBelieveAcc**\n\n${activeServices.join(
                  "\n\n"
                )}`;
                message.channel.send(
                  new discord.MessageEmbed()
                      ...
                      if (number.toString() === "NaN") return;
                        ...
                        doneCollector.on("collect", (message) => {
                          ...
                          if (doneContent === "-done") {
                            doneCollector.stop();
                            message.channel.send(
                              "*Thank you for your order!*\n**Tan** will review this ticket soon and fulfill your order. This can take up to **24 hours** if he is offline. If you haven't received your order within 24 hours, then you'll be automatically refunded.\n\n***NOTE**: Do **NOT** delete this ticket."
                            );
                          }
                        });
                      }
